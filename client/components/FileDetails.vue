							...
							>
								<div class="flex flex-col h-full overflow-y-auto">
									<div class="p-2">
										...
										<div class="mt-10">
											<button
												class="flex items-center justify-start w-full px-3 py-4 space-x-3 text-sm text-gray-500 transition-all rounded-lg hover:bg-red-50 hover:text-red-500"
											>
												<Icon name="bi:trash3" />
